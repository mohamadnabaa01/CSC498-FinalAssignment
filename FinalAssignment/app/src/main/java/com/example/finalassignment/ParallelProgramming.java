...
public class ParallelProgramming extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.parallel_programming);
        ...
        while(c != null) {//while cursor is not empty
            ...
            Log.i("name", name);
            if (name.equals("Parallel programming")){//if name is Parallel Programming
